...
function main(){
	...
	function inicia(ev){
		...
		var game;
		var auxSom = som;
		console.log("OISDKLDSFJKLSDF " + auxSom);
		if (dificuldade == "facil"){
			game = new GameEnv(botoes[0], botoes[1],botoes[2],botoes[3], botoes[4], botoes[5],null, null, ctx, imgSel,imgCerto, imgErrado,imgOptn, use5050, ev.target, Facil, null, canvas, auxSom);
		}
		else if (dificuldade == "medio"){
			game = new GameEnv(botoes[0], botoes[1],botoes[2],botoes[3], botoes[4], botoes[5],null, null, ctx, imgSel,imgCerto, imgErrado,imgOptn, use5050, ev.target, Medio, null, canvas, auxSom);
		}
		else if (dificuldade == "dificil"){
			game = new GameEnv(botoes[0], botoes[1],botoes[2],botoes[3], botoes[4], botoes[5],null, null, ctx, imgSel,imgCerto, imgErrado,imgOptn, use5050, ev.target, Dificil, null, canvas, auxSom);
		}
